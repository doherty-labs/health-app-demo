...
class AppointmentAnalytics:
    @inject
    def __init__(self, elastic_service: AppointmentIndex):
    ...
    def get_all_stats(
        ...
        count_by_state = self.get_appointment_by_state(
            practice_id, start_date, end_date
        )
        overall_count = self.get_appointment_count(
            practice_id, start_date, end_date, interval
        )
        avg_time_in_state = self.get_avg_time_in_state(
            practice_id, start_date, end_date
        )
        return AppointmentAnalyticsSchema(
